...
def send_email(num,sender_email,passw,rec_email,admin_email,name,img,r):
    try:
        ...
        new_mail = SendMail([rec_email,admin_email], f'Spotted {name}',
                            f"Hey,\nI am attaching Image of found person.\nMy contact Number:{num}\nAutogenerated Location Details : 'ip': '49.37.194.58', 'city': 'thiruvallur', 'region': 'Tamil Nadu', 'country': 'IN', 'loc': '11.0055,76.9661', 'org': 'AS55836 Reliance Jio Infocomm Limited', 'postal': '641011', 'timezone': 'Asia/Kolkata'", 
                            sender_email)
